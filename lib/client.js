window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$1 = ".dTQgsW_root{--approval-border:color-mix(in srgb, currentColor 14%, transparent);--approval-muted:color-mix(in srgb, currentColor 65%, transparent);--approval-fill:color-mix(in srgb, currentColor 3%, transparent);--approval-accent:var(--dsw-alias-brand-primary-new-colorprimary-new-color,#3568d4);--approval-warning-fallback:#985300;--approval-error-fallback:#b42332;--approval-warning:var(--dsw-alias-state-warn-label,var(--approval-warning-fallback));--approval-error:var(--dsw-alias-state-error-primary,var(--approval-error-fallback));width:100%;min-width:0;max-width:840px;color:inherit;overflow-wrap:anywhere;gap:20px;margin-inline:auto;font-size:13px;line-height:1.5;display:grid}.dTQgsW_root *,.dTQgsW_root :before,.dTQgsW_root :after{box-sizing:border-box}.dTQgsW_root h2,.dTQgsW_root h3,.dTQgsW_root p{margin:0}.dTQgsW_root h3{font-size:13px;font-weight:600}.dTQgsW_pageTitle{letter-spacing:-.025em;font-size:22px;font-weight:650;line-height:1.3}.dTQgsW_title{font-size:15px}.dTQgsW_heading,.dTQgsW_row,.dTQgsW_rowBetween{align-items:center;gap:12px;display:flex}.dTQgsW_heading,.dTQgsW_rowBetween{justify-content:space-between}.dTQgsW_heading{flex-wrap:wrap}.dTQgsW_heading>div{min-width:0}.dTQgsW_titleRow{flex-wrap:wrap;align-items:center;gap:10px;display:flex}.dTQgsW_row{flex-wrap:wrap}.dTQgsW_muted,.dTQgsW_inlineHint,.dTQgsW_saveStatus{color:var(--approval-muted)}.dTQgsW_inlineHint{font-size:12px}.dTQgsW_root .dTQgsW_inlineHint{margin-top:-8px}.dTQgsW_saveStatus{font-size:12px}.dTQgsW_warning{color:var(--approval-warning)}.dTQgsW_error{color:var(--approval-error);border:1px solid;border-radius:8px;padding:10px 12px}.dTQgsW_card,.dTQgsW_editor{border:1px solid var(--approval-border);border-radius:10px;gap:10px;min-width:0;padding:16px;display:grid}.dTQgsW_editor{border-color:color-mix(in srgb, var(--approval-accent) 55%, transparent)}.dTQgsW_grid,.dTQgsW_filters{grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;display:grid}.dTQgsW_filters{border:1px solid var(--approval-border);border-radius:10px;align-items:end;padding:14px}.dTQgsW_panel,.dTQgsW_recordList{gap:20px;min-width:0;display:grid}.dTQgsW_tabs{border-bottom:1px solid var(--approval-border);gap:20px;padding:2px 2px 0;display:flex;overflow-x:auto}.dTQgsW_tab{color:var(--approval-muted);cursor:pointer;font:inherit;white-space:nowrap;background:0 0;border:0;border-bottom:2px solid #0000;flex:none;padding:9px 1px 11px;position:relative}.dTQgsW_tab[aria-selected=true]{color:inherit;border-bottom-color:var(--approval-accent);font-weight:600}.dTQgsW_button{border:1px solid var(--approval-border);width:fit-content;max-width:100%;min-height:34px;color:inherit;cursor:pointer;font:inherit;text-align:center;background:0 0;border-radius:7px;padding:6px 11px}.dTQgsW_button:hover:not(:disabled),.dTQgsW_tab:hover{background:var(--approval-fill)}.dTQgsW_textButton{color:var(--approval-accent);font:inherit;cursor:pointer;background:0 0;border:0;padding:6px 0}.dTQgsW_textButton:hover{text-decoration:underline}.dTQgsW_root :is(button,input,select,summary,[role=tabpanel]):focus-visible{outline:2px solid var(--approval-accent);outline-offset:3px}.dTQgsW_root :is(button,input,select):disabled{opacity:.55;cursor:not-allowed}.dTQgsW_field{align-content:start;gap:7px;min-width:0;display:grid}.dTQgsW_field>span:first-child{font-weight:500}.dTQgsW_field input,.dTQgsW_field select{border:1px solid var(--approval-border);width:100%;min-width:0;min-height:37px;color:inherit;background:var(--dsw-alias-background-primary,Canvas);font:inherit;border-radius:7px;padding:7px 10px}.dTQgsW_field input[aria-invalid=true]{border-color:var(--approval-error)}.dTQgsW_settingsGroup{border:1px solid var(--approval-border);border-radius:10px;min-width:0}.dTQgsW_settingRow{grid-template-columns:minmax(100px,1fr) minmax(0,1.7fr);align-items:center;gap:24px;min-width:0;padding:15px 18px;display:grid}.dTQgsW_settingRow+.dTQgsW_settingRow{border-top:1px solid var(--approval-border)}.dTQgsW_toggleRow{cursor:pointer;justify-content:space-between;min-height:58px;display:flex}.dTQgsW_toggle{appearance:none;border:1px solid var(--approval-border);background:color-mix(in srgb, currentColor 22%, transparent);cursor:pointer;border-radius:20px;flex:none;width:36px;height:20px;margin:0;position:relative}.dTQgsW_toggle:after{content:\"\";background:#fff;border-radius:50%;width:14px;height:14px;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #0003}.dTQgsW_toggle:checked{background:var(--approval-accent);border-color:var(--approval-accent)}.dTQgsW_toggle:checked:after{transform:translate(16px)}.dTQgsW_switchLabel{cursor:pointer;align-items:center;gap:8px;width:fit-content;min-height:32px;display:inline-flex}.dTQgsW_switchLabel input{width:17px;height:17px;accent-color:var(--approval-accent);margin:0}.dTQgsW_fieldset{border:0;gap:14px;min-width:0;margin:0;padding:0;display:grid}.dTQgsW_notice{border-inline-start:2px solid var(--approval-accent);background:var(--approval-fill);border-radius:0 7px 7px 0;gap:9px;padding:12px 14px;display:grid}.dTQgsW_badge{border:1px solid var(--approval-border);width:fit-content;color:var(--approval-muted);white-space:normal;border-radius:5px;align-items:center;padding:2px 7px;font-size:11px;font-weight:400;display:inline-flex}.dTQgsW_empty{text-align:center;color:var(--approval-muted);justify-items:center;gap:12px;padding:30px 16px;display:grid}.dTQgsW_activity{min-width:0}.dTQgsW_activity .dTQgsW_rowBetween{margin-bottom:10px}.dTQgsW_quietEmpty{border:1px dashed var(--approval-border);text-align:center;color:var(--approval-muted);border-radius:9px;padding:26px 16px}.dTQgsW_quietEmpty span{margin-top:5px;font-size:12px;display:block}.dTQgsW_activityList{margin:0;padding:0;list-style:none}.dTQgsW_activityList li{border-bottom:1px solid var(--approval-border);justify-content:space-between;align-items:center;gap:16px;padding:12px 0;display:flex}.dTQgsW_activityName{gap:3px;min-width:0;display:grid}.dTQgsW_activityName strong{text-overflow:ellipsis;white-space:nowrap;font-weight:500;overflow:hidden}.dTQgsW_activityName time{color:var(--approval-muted);font-size:11px}.dTQgsW_help{color:var(--approval-muted);border-top:1px solid var(--approval-border);padding-top:13px}.dTQgsW_help>summary{cursor:pointer;width:fit-content;padding:3px 0;font-size:12px}.dTQgsW_helpBody{gap:12px;padding:14px 0 2px;font-size:12px;line-height:1.65;display:grid}.dTQgsW_supportList{gap:12px;margin:0;display:grid}.dTQgsW_supportList dt{font-weight:600}.dTQgsW_supportList dd{margin:3px 0 0}.dTQgsW_metadata{grid-template-columns:repeat(2,minmax(0,1fr));gap:12px 22px;min-width:0;margin:0;display:grid}.dTQgsW_metadata>div{min-width:0}.dTQgsW_metadata dt{color:var(--approval-muted);margin-bottom:3px;font-size:12px}.dTQgsW_metadata dd{overflow-wrap:anywhere;white-space:pre-wrap;margin:0}.dTQgsW_metadata pre{white-space:pre-wrap;overflow-wrap:anywhere;max-height:240px;font:inherit;margin:0;overflow:auto}.dTQgsW_mono{font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.dTQgsW_summary{white-space:pre-wrap}.dTQgsW_details{border-top:1px solid var(--approval-border);padding-top:10px}.dTQgsW_details summary{cursor:pointer;width:fit-content;padding:3px 0;font-weight:500}.dTQgsW_details[open] summary{margin-bottom:12px}.dTQgsW_preview{border-top:1px solid var(--approval-border);gap:12px;padding-top:14px;display:grid}.dTQgsW_permissionModeIcon{flex:none;justify-content:center;align-items:center;display:inline-flex}.dTQgsW_permissionModeIcon svg{display:block}.dTQgsW_permissionModeIconMenu{width:16px;height:16px;color:inherit}.dTQgsW_permissionModeIconTrigger,.dTQgsW_permissionModeIconTrigger svg{width:14px;height:14px;color:inherit}@media (prefers-color-scheme:dark){.dTQgsW_root{--approval-warning-fallback:#edbd77;--approval-error-fallback:#ffabb5}}@media (width<=640px){.dTQgsW_grid,.dTQgsW_filters,.dTQgsW_metadata{grid-template-columns:minmax(0,1fr)}.dTQgsW_settingRow:not(.dTQgsW_toggleRow){grid-template-columns:minmax(0,1fr);gap:8px}.dTQgsW_settingRow{padding:13px 14px}.dTQgsW_heading>*{max-width:100%}.dTQgsW_card,.dTQgsW_editor{padding:14px}.dTQgsW_pageTitle{font-size:21px}}@media (forced-colors:active){.dTQgsW_root{--approval-border:CanvasText;--approval-accent:Highlight;--approval-muted:CanvasText;--approval-warning:CanvasText;--approval-error:CanvasText}.dTQgsW_tab[aria-selected=true]{border-bottom-color:highlight}.dTQgsW_toggle{appearance:auto}.dTQgsW_toggle:after{display:none}}";
		...
		var styles_module_css_default = {
			"activity": "dTQgsW_activity",
			"activityList": "dTQgsW_activityList",
			"activityName": "dTQgsW_activityName",
			"badge": "dTQgsW_badge",
			"button": "dTQgsW_button",
			"card": "dTQgsW_card",
			"details": "dTQgsW_details",
			"editor": "dTQgsW_editor",
			"empty": "dTQgsW_empty",
			"error": "dTQgsW_error",
			"field": "dTQgsW_field",
			"fieldset": "dTQgsW_fieldset",
			"filters": "dTQgsW_filters",
			"grid": "dTQgsW_grid",
			"heading": "dTQgsW_heading",
			"help": "dTQgsW_help",
			"helpBody": "dTQgsW_helpBody",
			"inlineHint": "dTQgsW_inlineHint",
			"metadata": "dTQgsW_metadata",
			"mono": "dTQgsW_mono",
			"muted": "dTQgsW_muted",
			"notice": "dTQgsW_notice",
			"pageTitle": "dTQgsW_pageTitle",
			"panel": "dTQgsW_panel",
			"permissionModeIcon": "dTQgsW_permissionModeIcon",
			"permissionModeIconMenu": "dTQgsW_permissionModeIconMenu",
			"permissionModeIconTrigger": "dTQgsW_permissionModeIconTrigger",
			"preview": "dTQgsW_preview",
			"quietEmpty": "dTQgsW_quietEmpty",
			"recordList": "dTQgsW_recordList",
			"root": "dTQgsW_root",
			"row": "dTQgsW_row",
			"rowBetween": "dTQgsW_rowBetween",
			"saveStatus": "dTQgsW_saveStatus",
			"settingRow": "dTQgsW_settingRow",
			"settingsGroup": "dTQgsW_settingsGroup",
			"summary": "dTQgsW_summary",
			"supportList": "dTQgsW_supportList",
			"switchLabel": "dTQgsW_switchLabel",
			"tab": "dTQgsW_tab",
			"tabs": "dTQgsW_tabs",
			"textButton": "dTQgsW_textButton",
			"title": "dTQgsW_title",
			"titleRow": "dTQgsW_titleRow",
			"toggle": "dTQgsW_toggle",
			"toggleRow": "dTQgsW_toggleRow",
			"warning": "dTQgsW_warning"
		};
		//#endregion
		...
		const css = ".I-yfYW_root{--creator-confirm-border:color-mix(in srgb, currentColor 16%, transparent);--creator-confirm-muted:color-mix(in srgb, currentColor 68%, transparent);--creator-confirm-fill:color-mix(in srgb, currentColor 3%, transparent);--creator-confirm-accent:var(--dsw-alias-brand-primary-new-colorprimary-new-color,#3568d4);box-sizing:border-box;border:1px solid var(--creator-confirm-border);background:var(--creator-confirm-fill);width:100%;min-width:0;max-width:760px;color:inherit;font:inherit;overflow-wrap:anywhere;border-radius:12px;padding:16px;font-size:13px;line-height:1.5}.I-yfYW_root *,.I-yfYW_root :before,.I-yfYW_root :after{box-sizing:border-box}.I-yfYW_heading,.I-yfYW_actions,.I-yfYW_footer,.I-yfYW_duration{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.I-yfYW_heading{justify-content:space-between;margin-bottom:4px}.I-yfYW_heading h3{margin:0;font-size:14px;font-weight:600}.I-yfYW_badge{background:var(--creator-confirm-fill);border-radius:5px;padding:2px 7px;font-size:11px}.I-yfYW_plugin{font-family:ui-monospace,SFMono-Regular,monospace;font-size:13px;display:block}.I-yfYW_target,.I-yfYW_summary{gap:3px;margin:8px 0 12px;display:grid}.I-yfYW_target>div,.I-yfYW_summary>div{grid-template-columns:minmax(65px,auto) minmax(0,1fr);gap:10px;display:grid}.I-yfYW_target dt,.I-yfYW_summary dt{color:var(--creator-confirm-muted)}.I-yfYW_target dd,.I-yfYW_summary dd{min-width:0;margin:0}.I-yfYW_fieldset{border:0;min-width:0;margin:0;padding:0}.I-yfYW_fieldset legend{margin-bottom:6px;padding:0;font-weight:500}.I-yfYW_lifetimes{grid-template-columns:repeat(3,minmax(0,1fr));gap:6px;display:grid}.I-yfYW_choice{border:1px solid var(--creator-confirm-border);cursor:pointer;border-radius:7px;align-items:flex-start;gap:6px;min-width:0;padding:8px;display:flex}.I-yfYW_choice:has(input:checked){background:color-mix(in srgb, var(--creator-confirm-accent) 7%, transparent);border-color:var(--creator-confirm-accent)}.I-yfYW_choice:has(input:disabled){opacity:.55;cursor:not-allowed}.I-yfYW_choice input,.I-yfYW_operations input,.I-yfYW_acknowledgement input{accent-color:var(--creator-confirm-accent);flex:none;margin:3px 0 0}.I-yfYW_hint,.I-yfYW_task{color:var(--creator-confirm-muted);margin:7px 0;font-size:12px}.I-yfYW_task{color:inherit}.I-yfYW_details{margin:8px 0}.I-yfYW_details summary{cursor:pointer;color:var(--creator-confirm-muted);font-size:12px}.I-yfYW_operations{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px 12px;padding:9px 0 4px;display:grid}.I-yfYW_operations label,.I-yfYW_acknowledgement{align-items:flex-start;gap:7px;min-width:0;display:flex}.I-yfYW_operations small{color:var(--creator-confirm-muted);font-size:11px}.I-yfYW_duration{margin-top:9px;font-size:12px}.I-yfYW_duration select{color:inherit;border:1px solid var(--creator-confirm-border);font:inherit;background:0 0;border-radius:5px;padding:4px 7px}.I-yfYW_actions{justify-content:flex-end;margin-top:12px}.I-yfYW_primary,.I-yfYW_secondary{min-height:33px;font:inherit;cursor:pointer;border-radius:7px;padding:6px 12px}.I-yfYW_primary{color:#fff;background:var(--creator-confirm-accent);border:1px solid var(--creator-confirm-accent)}.I-yfYW_secondary{color:inherit;border:1px solid var(--creator-confirm-border);background:0 0}.I-yfYW_root button:disabled,.I-yfYW_root fieldset:disabled{opacity:.6;cursor:not-allowed}.I-yfYW_root :is(button,input,select,summary):focus-visible{outline:2px solid var(--creator-confirm-accent);outline-offset:3px}.I-yfYW_confirmation{border:1px solid color-mix(in srgb, var(--creator-confirm-accent) 55%, transparent);background:var(--creator-confirm-fill);border-radius:8px;padding:10px 12px}.I-yfYW_confirmation h4{margin:0 0 6px;font-size:13px}.I-yfYW_confirmation p{margin:0 0 8px}.I-yfYW_acknowledgement{padding-top:5px;font-weight:500}.I-yfYW_footer{color:var(--creator-confirm-muted);justify-content:space-between;margin-top:10px;font-size:11px}.I-yfYW_footer button{color:inherit;text-underline-offset:2px;cursor:pointer;font:inherit;background:0 0;border:0;padding:0;text-decoration:underline}.I-yfYW_reason{white-space:pre-wrap;margin:6px 0 0;font-size:12px}.I-yfYW_error{color:var(--dsw-alias-state-error-primary,#b42332);margin:8px 0 0;font-size:12px}@media (width<=480px){.I-yfYW_root{padding:12px}.I-yfYW_choice{gap:4px;padding:7px 5px;font-size:12px}.I-yfYW_operations{grid-template-columns:minmax(0,1fr)}.I-yfYW_target>div,.I-yfYW_summary>div{grid-template-columns:minmax(0,1fr);gap:1px}.I-yfYW_actions>button{flex:auto}}@media (prefers-reduced-motion:reduce){.I-yfYW_root *{scroll-behavior:auto;transition:none;animation:none}}";
		...
		var creator_approval_module_css_default = {
			"acknowledgement": "I-yfYW_acknowledgement",
			"actions": "I-yfYW_actions",
			"badge": "I-yfYW_badge",
			"choice": "I-yfYW_choice",
			"confirmation": "I-yfYW_confirmation",
			"details": "I-yfYW_details",
			"duration": "I-yfYW_duration",
			"error": "I-yfYW_error",
			"fieldset": "I-yfYW_fieldset",
			"footer": "I-yfYW_footer",
			"heading": "I-yfYW_heading",
			"hint": "I-yfYW_hint",
			"lifetimes": "I-yfYW_lifetimes",
			"operations": "I-yfYW_operations",
			"plugin": "I-yfYW_plugin",
			"primary": "I-yfYW_primary",
			"reason": "I-yfYW_reason",
			"root": "I-yfYW_root",
			"secondary": "I-yfYW_secondary",
			"summary": "I-yfYW_summary",
			"target": "I-yfYW_target",
			"task": "I-yfYW_task"
		};
		//#endregion
