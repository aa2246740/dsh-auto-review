window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dshx-css-module:/Users/wu/Documents/Codex/2026-08-15/bang/deepseek-harness-rc8/my-plugins/dsh-approve-for-me/src/client/styles.module.css.mjs
		const css = ".CDOHsW_card{border:1px solid color-mix(in srgb, currentColor 14%, transparent);background:color-mix(in srgb, currentColor 3%, transparent);border-radius:14px;gap:16px;padding:18px;display:grid}.CDOHsW_permissionModeIcon{flex:none;justify-content:center;align-items:center;display:inline-flex}.CDOHsW_permissionModeIcon svg{display:block}.CDOHsW_permissionModeIconMenu{width:16px;height:16px;color:var(--dsw-alias-label-tertiary)}.CDOHsW_permissionModeIconTrigger{width:14px;height:14px;color:inherit}.CDOHsW_permissionModeIconTrigger svg{width:14px;height:14px}@container (width<=460px){[data-dsh-approve-for-me-trigger] [data-dsh-approve-for-me-label]{display:none}}.CDOHsW_heading{justify-content:space-between;align-items:flex-start;gap:20px;display:flex}.CDOHsW_title{margin:0;font-size:16px;line-height:24px}.CDOHsW_subtitle,.CDOHsW_muted,.CDOHsW_warning,.CDOHsW_details p{margin:4px 0 0;font-size:13px;line-height:20px}.CDOHsW_subtitle,.CDOHsW_muted,.CDOHsW_details p{color:color-mix(in srgb, currentColor 66%, transparent)}.CDOHsW_warning{color:#c2410c}.CDOHsW_switchLabel{flex:none;align-items:center;gap:8px;font-size:13px;font-weight:600;display:inline-flex}.CDOHsW_switchLabel input{accent-color:#16a34a;width:17px;height:17px}.CDOHsW_field{gap:7px;display:grid}.CDOHsW_fieldLabel{font-size:13px;font-weight:600}.CDOHsW_field select,.CDOHsW_advancedGrid input{box-sizing:border-box;border:1px solid color-mix(in srgb, currentColor 18%, transparent);width:100%;min-height:38px;color:inherit;background:canvas;border-radius:9px;padding:8px 10px}.CDOHsW_statusRow{justify-content:space-between;align-items:center;gap:12px;display:flex}.CDOHsW_refresh{border:1px solid color-mix(in srgb, currentColor 18%, transparent);color:inherit;cursor:pointer;background:0 0;border-radius:8px;padding:6px 11px}.CDOHsW_refresh:disabled,.CDOHsW_field select:disabled,.CDOHsW_advancedGrid input:disabled{cursor:default;opacity:.55}.CDOHsW_details{border-top:1px solid color-mix(in srgb, currentColor 10%, transparent);padding-top:12px;font-size:13px}.CDOHsW_details summary{cursor:pointer;font-weight:600}.CDOHsW_advancedGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-top:12px;display:grid}.CDOHsW_advancedGrid label{gap:6px;font-size:12px;display:grid}@media (width<=680px){.CDOHsW_heading,.CDOHsW_statusRow{flex-direction:column;align-items:stretch}.CDOHsW_advancedGrid{grid-template-columns:1fr}}";
		...
		var styles_module_css_default = {
			"advancedGrid": "CDOHsW_advancedGrid",
			"card": "CDOHsW_card",
			"details": "CDOHsW_details",
			"field": "CDOHsW_field",
			"fieldLabel": "CDOHsW_fieldLabel",
			"heading": "CDOHsW_heading",
			"muted": "CDOHsW_muted",
			"permissionModeIcon": "CDOHsW_permissionModeIcon",
			"permissionModeIconMenu": "CDOHsW_permissionModeIconMenu",
			"permissionModeIconTrigger": "CDOHsW_permissionModeIconTrigger",
			"refresh": "CDOHsW_refresh",
			"statusRow": "CDOHsW_statusRow",
			"subtitle": "CDOHsW_subtitle",
			"switchLabel": "CDOHsW_switchLabel",
			"title": "CDOHsW_title",
			"warning": "CDOHsW_warning"
		};
		//#endregion
		...
		function isPermissionPresetMenu(labels) {
			return labels.includes("Approve for me") && REQUIRED_PERMISSION_ROWS.every((label) => labels.includes(label));
		}
		function createSvg() {
		...
		function enhanceCurrentTrigger(root) {
			for (const button of root.querySelectorAll("button[aria-label]")) {
				if (!button.getAttribute("aria-label")?.includes("Approve for me")) continue;
