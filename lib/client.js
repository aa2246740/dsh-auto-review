window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$1 = ".btRHXW_root{--approval-border:color-mix(in srgb, currentColor 14%, transparent);--approval-muted:color-mix(in srgb, currentColor 65%, transparent);--approval-fill:color-mix(in srgb, currentColor 3%, transparent);--approval-accent:var(--dsw-alias-brand-primary-new-colorprimary-new-color,#3568d4);--approval-warning-fallback:#985300;--approval-error-fallback:#b42332;--approval-warning:var(--dsw-alias-state-warn-label,var(--approval-warning-fallback));--approval-error:var(--dsw-alias-state-error-primary,var(--approval-error-fallback));width:100%;min-width:0;max-width:840px;color:inherit;overflow-wrap:anywhere;gap:20px;margin-inline:auto;font-size:13px;line-height:1.5;display:grid}.btRHXW_root *,.btRHXW_root :before,.btRHXW_root :after{box-sizing:border-box}.btRHXW_root h2,.btRHXW_root h3,.btRHXW_root p{margin:0}.btRHXW_root h3{font-size:13px;font-weight:600}.btRHXW_pageTitle{letter-spacing:-.025em;font-size:22px;font-weight:650;line-height:1.3}.btRHXW_title{font-size:15px}.btRHXW_heading,.btRHXW_row,.btRHXW_rowBetween{align-items:center;gap:12px;display:flex}.btRHXW_heading,.btRHXW_rowBetween{justify-content:space-between}.btRHXW_heading{flex-wrap:wrap}.btRHXW_heading>div{min-width:0}.btRHXW_titleRow{flex-wrap:wrap;align-items:center;gap:10px;display:flex}.btRHXW_row{flex-wrap:wrap}.btRHXW_muted,.btRHXW_inlineHint,.btRHXW_saveStatus{color:var(--approval-muted)}.btRHXW_inlineHint{font-size:12px}.btRHXW_root .btRHXW_inlineHint{margin-top:-8px}.btRHXW_saveStatus{font-size:12px}.btRHXW_warning{color:var(--approval-warning)}.btRHXW_error{color:var(--approval-error);border:1px solid;border-radius:8px;padding:10px 12px}.btRHXW_card,.btRHXW_editor{border:1px solid var(--approval-border);border-radius:10px;gap:10px;min-width:0;padding:16px;display:grid}.btRHXW_editor{border-color:color-mix(in srgb, var(--approval-accent) 55%, transparent)}.btRHXW_grid,.btRHXW_filters{grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;display:grid}.btRHXW_filters{border:1px solid var(--approval-border);border-radius:10px;align-items:end;padding:14px}.btRHXW_panel,.btRHXW_recordList{gap:20px;min-width:0;display:grid}.btRHXW_tabs{border-bottom:1px solid var(--approval-border);gap:20px;padding:2px 2px 0;display:flex;overflow-x:auto}.btRHXW_tab{color:var(--approval-muted);cursor:pointer;font:inherit;white-space:nowrap;background:0 0;border:0;border-bottom:2px solid #0000;flex:none;padding:9px 1px 11px;position:relative}.btRHXW_tab[aria-selected=true]{color:inherit;border-bottom-color:var(--approval-accent);font-weight:600}.btRHXW_button{border:1px solid var(--approval-border);width:fit-content;max-width:100%;min-height:34px;color:inherit;cursor:pointer;font:inherit;text-align:center;background:0 0;border-radius:7px;padding:6px 11px}.btRHXW_button:hover:not(:disabled),.btRHXW_tab:hover{background:var(--approval-fill)}.btRHXW_textButton{color:var(--approval-accent);font:inherit;cursor:pointer;background:0 0;border:0;padding:6px 0}.btRHXW_textButton:hover{text-decoration:underline}.btRHXW_root :is(button,input,select,summary,[role=tabpanel]):focus-visible{outline:2px solid var(--approval-accent);outline-offset:3px}.btRHXW_root :is(button,input,select):disabled{opacity:.55;cursor:not-allowed}.btRHXW_field{align-content:start;gap:7px;min-width:0;display:grid}.btRHXW_field>span:first-child{font-weight:500}.btRHXW_field input,.btRHXW_field select{border:1px solid var(--approval-border);width:100%;min-width:0;min-height:37px;color:inherit;background:var(--dsw-alias-background-primary,Canvas);font:inherit;border-radius:7px;padding:7px 10px}.btRHXW_field input[aria-invalid=true]{border-color:var(--approval-error)}.btRHXW_settingsGroup{border:1px solid var(--approval-border);border-radius:10px;min-width:0}.btRHXW_settingRow{grid-template-columns:minmax(100px,1fr) minmax(0,1.7fr);align-items:center;gap:24px;min-width:0;padding:15px 18px;display:grid}.btRHXW_settingRow+.btRHXW_settingRow{border-top:1px solid var(--approval-border)}.btRHXW_toggleRow{cursor:pointer;justify-content:space-between;min-height:58px;display:flex}.btRHXW_toggle{appearance:none;border:1px solid var(--approval-border);background:color-mix(in srgb, currentColor 22%, transparent);cursor:pointer;border-radius:20px;flex:none;width:36px;height:20px;margin:0;position:relative}.btRHXW_toggle:after{content:\"\";background:#fff;border-radius:50%;width:14px;height:14px;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #0003}.btRHXW_toggle:checked{background:var(--approval-accent);border-color:var(--approval-accent)}.btRHXW_toggle:checked:after{transform:translate(16px)}.btRHXW_switchLabel{cursor:pointer;align-items:center;gap:8px;width:fit-content;min-height:32px;display:inline-flex}.btRHXW_switchLabel input{width:17px;height:17px;accent-color:var(--approval-accent);margin:0}.btRHXW_fieldset{border:0;gap:14px;min-width:0;margin:0;padding:0;display:grid}.btRHXW_notice{border-inline-start:2px solid var(--approval-accent);background:var(--approval-fill);border-radius:0 7px 7px 0;gap:9px;padding:12px 14px;display:grid}.btRHXW_badge{border:1px solid var(--approval-border);width:fit-content;color:var(--approval-muted);white-space:normal;border-radius:5px;align-items:center;padding:2px 7px;font-size:11px;font-weight:400;display:inline-flex}.btRHXW_empty{text-align:center;color:var(--approval-muted);justify-items:center;gap:12px;padding:30px 16px;display:grid}.btRHXW_activity{min-width:0}.btRHXW_activity .btRHXW_rowBetween{margin-bottom:10px}.btRHXW_quietEmpty{border:1px dashed var(--approval-border);text-align:center;color:var(--approval-muted);border-radius:9px;padding:26px 16px}.btRHXW_quietEmpty span{margin-top:5px;font-size:12px;display:block}.btRHXW_activityList{margin:0;padding:0;list-style:none}.btRHXW_activityList li{border-bottom:1px solid var(--approval-border);justify-content:space-between;align-items:center;gap:16px;padding:12px 0;display:flex}.btRHXW_activityName{gap:3px;min-width:0;display:grid}.btRHXW_activityName strong{text-overflow:ellipsis;white-space:nowrap;font-weight:500;overflow:hidden}.btRHXW_activityName time{color:var(--approval-muted);font-size:11px}.btRHXW_help{color:var(--approval-muted);border-top:1px solid var(--approval-border);padding-top:13px}.btRHXW_help>summary{cursor:pointer;width:fit-content;padding:3px 0;font-size:12px}.btRHXW_helpBody{gap:12px;padding:14px 0 2px;font-size:12px;line-height:1.65;display:grid}.btRHXW_supportList{gap:12px;margin:0;display:grid}.btRHXW_supportList dt{font-weight:600}.btRHXW_supportList dd{margin:3px 0 0}.btRHXW_metadata{grid-template-columns:repeat(2,minmax(0,1fr));gap:12px 22px;min-width:0;margin:0;display:grid}.btRHXW_metadata>div{min-width:0}.btRHXW_metadata dt{color:var(--approval-muted);margin-bottom:3px;font-size:12px}.btRHXW_metadata dd{overflow-wrap:anywhere;white-space:pre-wrap;margin:0}.btRHXW_metadata pre{white-space:pre-wrap;overflow-wrap:anywhere;max-height:240px;font:inherit;margin:0;overflow:auto}.btRHXW_mono{font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.btRHXW_summary{white-space:pre-wrap}.btRHXW_details{border-top:1px solid var(--approval-border);padding-top:10px}.btRHXW_details summary{cursor:pointer;width:fit-content;padding:3px 0;font-weight:500}.btRHXW_details[open] summary{margin-bottom:12px}.btRHXW_preview{border-top:1px solid var(--approval-border);gap:12px;padding-top:14px;display:grid}.btRHXW_permissionModeIcon{flex:none;justify-content:center;align-items:center;display:inline-flex}.btRHXW_permissionModeIcon svg{display:block}.btRHXW_permissionModeIconMenu{width:16px;height:16px;color:inherit}.btRHXW_permissionModeIconTrigger,.btRHXW_permissionModeIconTrigger svg{width:14px;height:14px;color:inherit}@media (prefers-color-scheme:dark){.btRHXW_root{--approval-warning-fallback:#edbd77;--approval-error-fallback:#ffabb5}}@media (width<=640px){.btRHXW_grid,.btRHXW_filters,.btRHXW_metadata{grid-template-columns:minmax(0,1fr)}.btRHXW_settingRow:not(.btRHXW_toggleRow){grid-template-columns:minmax(0,1fr);gap:8px}.btRHXW_settingRow{padding:13px 14px}.btRHXW_heading>*{max-width:100%}.btRHXW_card,.btRHXW_editor{padding:14px}.btRHXW_pageTitle{font-size:21px}}@media (forced-colors:active){.btRHXW_root{--approval-border:CanvasText;--approval-accent:Highlight;--approval-muted:CanvasText;--approval-warning:CanvasText;--approval-error:CanvasText}.btRHXW_tab[aria-selected=true]{border-bottom-color:highlight}.btRHXW_toggle{appearance:auto}.btRHXW_toggle:after{display:none}}";
		...
		var styles_module_css_default = {
			"activity": "btRHXW_activity",
			"activityList": "btRHXW_activityList",
			"activityName": "btRHXW_activityName",
			"badge": "btRHXW_badge",
			"button": "btRHXW_button",
			"card": "btRHXW_card",
			"details": "btRHXW_details",
			"editor": "btRHXW_editor",
			"empty": "btRHXW_empty",
			"error": "btRHXW_error",
			"field": "btRHXW_field",
			"fieldset": "btRHXW_fieldset",
			"filters": "btRHXW_filters",
			"grid": "btRHXW_grid",
			"heading": "btRHXW_heading",
			"help": "btRHXW_help",
			"helpBody": "btRHXW_helpBody",
			"inlineHint": "btRHXW_inlineHint",
			"metadata": "btRHXW_metadata",
			"mono": "btRHXW_mono",
			"muted": "btRHXW_muted",
			"notice": "btRHXW_notice",
			"pageTitle": "btRHXW_pageTitle",
			"panel": "btRHXW_panel",
			"permissionModeIcon": "btRHXW_permissionModeIcon",
			"permissionModeIconMenu": "btRHXW_permissionModeIconMenu",
			"permissionModeIconTrigger": "btRHXW_permissionModeIconTrigger",
			"preview": "btRHXW_preview",
			"quietEmpty": "btRHXW_quietEmpty",
			"recordList": "btRHXW_recordList",
			"root": "btRHXW_root",
			"row": "btRHXW_row",
			"rowBetween": "btRHXW_rowBetween",
			"saveStatus": "btRHXW_saveStatus",
			"settingRow": "btRHXW_settingRow",
			"settingsGroup": "btRHXW_settingsGroup",
			"summary": "btRHXW_summary",
			"supportList": "btRHXW_supportList",
			"switchLabel": "btRHXW_switchLabel",
			"tab": "btRHXW_tab",
			"tabs": "btRHXW_tabs",
			"textButton": "btRHXW_textButton",
			"title": "btRHXW_title",
			"titleRow": "btRHXW_titleRow",
			"toggle": "btRHXW_toggle",
			"toggleRow": "btRHXW_toggleRow",
			"warning": "btRHXW_warning"
		};
		//#endregion
		...
		const css = ".oseING_root{--creator-confirm-border:color-mix(in srgb, currentColor 16%, transparent);--creator-confirm-muted:color-mix(in srgb, currentColor 68%, transparent);--creator-confirm-fill:color-mix(in srgb, currentColor 3%, transparent);--creator-confirm-accent:var(--dsw-alias-brand-primary-new-colorprimary-new-color,#3568d4);box-sizing:border-box;border:1px solid var(--creator-confirm-border);background:var(--creator-confirm-fill);width:100%;min-width:0;max-width:760px;color:inherit;font:inherit;overflow-wrap:anywhere;border-radius:12px;padding:16px;font-size:13px;line-height:1.5}.oseING_root *,.oseING_root :before,.oseING_root :after{box-sizing:border-box}.oseING_heading,.oseING_actions,.oseING_footer,.oseING_duration{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.oseING_heading{justify-content:space-between;margin-bottom:4px}.oseING_heading h3{margin:0;font-size:14px;font-weight:600}.oseING_badge{background:var(--creator-confirm-fill);border-radius:5px;padding:2px 7px;font-size:11px}.oseING_plugin{font-family:ui-monospace,SFMono-Regular,monospace;font-size:13px;display:block}.oseING_target,.oseING_summary{gap:3px;margin:8px 0 12px;display:grid}.oseING_target>div,.oseING_summary>div{grid-template-columns:minmax(65px,auto) minmax(0,1fr);gap:10px;display:grid}.oseING_target dt,.oseING_summary dt{color:var(--creator-confirm-muted)}.oseING_target dd,.oseING_summary dd{min-width:0;margin:0}.oseING_fieldset{border:0;min-width:0;margin:0;padding:0}.oseING_fieldset legend{margin-bottom:6px;padding:0;font-weight:500}.oseING_lifetimes{grid-template-columns:repeat(3,minmax(0,1fr));gap:6px;display:grid}.oseING_choice{border:1px solid var(--creator-confirm-border);cursor:pointer;border-radius:7px;align-items:flex-start;gap:6px;min-width:0;padding:8px;display:flex}.oseING_choice:has(input:checked){background:color-mix(in srgb, var(--creator-confirm-accent) 7%, transparent);border-color:var(--creator-confirm-accent)}.oseING_choice:has(input:disabled){opacity:.55;cursor:not-allowed}.oseING_choice input,.oseING_operations input,.oseING_acknowledgement input{accent-color:var(--creator-confirm-accent);flex:none;margin:3px 0 0}.oseING_hint,.oseING_task{color:var(--creator-confirm-muted);margin:7px 0;font-size:12px}.oseING_task{color:inherit}.oseING_details{margin:8px 0}.oseING_details summary{cursor:pointer;color:var(--creator-confirm-muted);font-size:12px}.oseING_operations{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px 12px;padding:9px 0 4px;display:grid}.oseING_operations label,.oseING_acknowledgement{align-items:flex-start;gap:7px;min-width:0;display:flex}.oseING_operations small{color:var(--creator-confirm-muted);font-size:11px}.oseING_duration{margin-top:9px;font-size:12px}.oseING_duration select{color:inherit;border:1px solid var(--creator-confirm-border);font:inherit;background:0 0;border-radius:5px;padding:4px 7px}.oseING_actions{justify-content:flex-end;margin-top:12px}.oseING_primary,.oseING_secondary{min-height:33px;font:inherit;cursor:pointer;border-radius:7px;padding:6px 12px}.oseING_primary{color:#fff;background:var(--creator-confirm-accent);border:1px solid var(--creator-confirm-accent)}.oseING_secondary{color:inherit;border:1px solid var(--creator-confirm-border);background:0 0}.oseING_root button:disabled,.oseING_root fieldset:disabled{opacity:.6;cursor:not-allowed}.oseING_root :is(button,input,select,summary):focus-visible{outline:2px solid var(--creator-confirm-accent);outline-offset:3px}.oseING_confirmation{border:1px solid color-mix(in srgb, var(--creator-confirm-accent) 55%, transparent);background:var(--creator-confirm-fill);border-radius:8px;padding:10px 12px}.oseING_confirmation h4{margin:0 0 6px;font-size:13px}.oseING_confirmation p{margin:0 0 8px}.oseING_acknowledgement{padding-top:5px;font-weight:500}.oseING_footer{color:var(--creator-confirm-muted);justify-content:space-between;margin-top:10px;font-size:11px}.oseING_footer button{color:inherit;text-underline-offset:2px;cursor:pointer;font:inherit;background:0 0;border:0;padding:0;text-decoration:underline}.oseING_reason{white-space:pre-wrap;margin:6px 0 0;font-size:12px}.oseING_error{color:var(--dsw-alias-state-error-primary,#b42332);margin:8px 0 0;font-size:12px}@media (width<=480px){.oseING_root{padding:12px}.oseING_choice{gap:4px;padding:7px 5px;font-size:12px}.oseING_operations{grid-template-columns:minmax(0,1fr)}.oseING_target>div,.oseING_summary>div{grid-template-columns:minmax(0,1fr);gap:1px}.oseING_actions>button{flex:auto}}@media (prefers-reduced-motion:reduce){.oseING_root *{scroll-behavior:auto;transition:none;animation:none}}";
		...
		var creator_approval_module_css_default = {
			"acknowledgement": "oseING_acknowledgement",
			"actions": "oseING_actions",
			"badge": "oseING_badge",
			"choice": "oseING_choice",
			"confirmation": "oseING_confirmation",
			"details": "oseING_details",
			"duration": "oseING_duration",
			"error": "oseING_error",
			"fieldset": "oseING_fieldset",
			"footer": "oseING_footer",
			"heading": "oseING_heading",
			"hint": "oseING_hint",
			"lifetimes": "oseING_lifetimes",
			"operations": "oseING_operations",
			"plugin": "oseING_plugin",
			"primary": "oseING_primary",
			"reason": "oseING_reason",
			"root": "oseING_root",
			"secondary": "oseING_secondary",
			"summary": "oseING_summary",
			"target": "oseING_target",
			"task": "oseING_task"
		};
		//#endregion
